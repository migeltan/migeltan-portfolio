            ...
            <div className="experience-list">
                ...
                <div className="exp-item">
                    ...
                    <div className="exp-content">
                        <h3 className="exp-title">Polytechnic University of the Philippines</h3>
                        <p className="exp-company">Bachelor of Science in Information Technology Sophomore</p>
                    </div>
                ...
                <div className="exp-item">
                    ...
                    <div className="exp-content">
                        ...
                        <p className="exp-company">Started Programming, enrolled in PUP BSIT!</p>
                    </div>
