...
const javasql = [
  {
    ...
    description: (
      <>
        <strong>CRUD Project:</strong> This project is a digitized registration
        form of the Pag-IBIG Membership Fund. Serving as a CRUD project for our
        second year, using Java as the programming language and MySQL as the
        database.
      </>
    ),
  },
